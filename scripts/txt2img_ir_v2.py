...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="outputs/txt2ir-ddpm-custom"
    )
    parser.add_argument(
        "--ddim_steps",
        type=int,
        ...
        with model.ema_scope():
            for i in range(0, 30):
                ...
                caption = ["This is a long-wave infrared image. And an aerial view of a nighttime street intersection. "
                           ...
                           "Additionally, part of a car's rear and an SUV are visible parked along the sidewalk. "
                           "The crosswalk at the intersection is marked with white lines. "
